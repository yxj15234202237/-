    ...
    <div class="content">
      ...
      <div class="p">
        <p>
          ...
          利用互联网将工地进行在线全景直播，通过去中介环节， 提供装修套餐 +
          个性化定制服务
        </p>
      </div>
      <footer>
...
export default {
  ...
  data() {
    return {
      image: ["/banner.jpg", "banner1.jpg", "banner2.jpg", "banner3.jpg"],
      images: ["img1.jpg", "banner3.jpg"],
    };
  },
  methods: {
    zhuan() {
